...
async function readReplaceWrapper(qparams, res) {
	...
	var result   = await readFileAndReplace(renderContent, "template.html");
	result = await readFileAndReplace(result, "banner"+qparams.banner+".html", "BANNER");
	result = await readFileAndReplace(result, "left"+qparams.left+".html", "LEFTNAV");
	result = await readFileAndReplace(result, "footer"+qparams.footer+".html", "FOOTER");
	result = await readFileAndReplace(result, "main"+qparams.main+".html", "MAIN");
